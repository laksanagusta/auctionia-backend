                    ...
                    <tbody>
                        @forelse($categories as $item)
                            <tr>
                                ...
                                <td class="border px-6 py-4 ">{{ $item->image }}</td>
                                <td class="border px-6 py-4 ">{{ $item->created_at }}</td>
                                <td class="border px-6 py-4 "><a href="{{ route('categories.edit', $item->id) }}" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mx-2 rounded">
                                    Edit
                                </a>
